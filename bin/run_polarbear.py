...
def pred_rna_norm(
    ...
    for batch_id in range(0, data_atac_test.shape[0] // batch_size + 1):
        ...
        test_translation_rna_norm[batch_id] = autoencoder.predict_rnanorm_translation(
            input_dim_rna,
            data_atac_test[index_range,].todense(),
            batch_atac_test[index_range,].todense(),
        )
...
def pred_atac_norm(
    ...
    for batch_id in range(0, data_rna_test.shape[0] // batch_size + 1):
        ...
        test_translator_reconstr_atac_norm[
            ...
            data_rna_test[index_range,].todense(),
            batch_rna_test[index_range,].todense(),
            input_dim_atac,
        )
...
def train_polarbear_model(
    ...
    if evaluate == "evaluate":
        ...
        eval_atac_AUROC_AUPR(
            autoencoder,
            data_rna[train_index,],
            data_atac[train_index,],
            data_rna_val,
            data_atac_val,
            batch_rna_val,
            data_rna_test,
